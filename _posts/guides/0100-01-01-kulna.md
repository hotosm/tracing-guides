...
<ul>
  ...
  <li> Agricultural land in the Khulna District of Bangladesh varies greatly depending on the season. Therefore, it is helpful to use different satellite imagery sources to get an alternative perspective on land use. The NextView licensed satellite imagery was collected January 15th, 2014 by DigitalGlobe. <li>Note: The collection date may be different from the Bing imagery.</li></li>
</ul>
</div>
