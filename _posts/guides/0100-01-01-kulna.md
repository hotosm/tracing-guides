...
<ul>
  ...
  <li> It is helpful to use different satellite imagery sources to get an alternative perspective on land use. The NextView licensed satellite imagery was collected January 15th, 2014 by DigitalGlobe (C). Note: The collection date may be different from the Bing imagery.</li>
