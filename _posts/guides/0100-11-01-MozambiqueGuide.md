...
footer: 
tips:
  - group: Buildings - The examples below are meant to help identify buildings in Mozambique using satellite imagery.   Please do not tag the building roof type, it is not needed for this project. 
    tips:
